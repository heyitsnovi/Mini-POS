...
let sales_report_tbl = $('.tbl-salesresult').DataTable( {
     ...
     dom: 'Bpftrip',
       "buttons": [{
        ...
        serverSide: true,
        ajax: {
            url: '/admin/sales/filter-transaction-dates', // Replace with your server endpoint
            type: 'POST',
		    data: function(d) {
        ...
        columns: [
            { data: 'product_code', title: 'Barcode #' },
            { data: 'assigned_or', title: 'Assigned OR #' },
            { data: 'date_sold', title: 'Date Sold' },
...
$('.tbl-salesresult').on('xhr.dt', function (e, settings, json, xhr) {
...
$('.btn-show-reports').on('click',function(){
 		...
 		sales_report_tbl.ajax.reload(function(json) {
         toastr["success"]("Reports has been generated");
    });
});

$('.btn-clear-reports-filter').on('click',function(){
